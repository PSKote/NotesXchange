...
import com.notesxchange.notesxchange.Utils.SectionsStatePagerAdapter;

/**
 * To to upload images of notes into database
 */
            ...
            if(intent.getStringExtra(getString(R.string.return_to_fragment)).equals(getString(R.string.edit_profile_fragment))){
                ...
                if(intent.hasExtra(getString(R.string.selected_image))){
                    ...
                    firebaseMethods.uploadNewPhoto(getString(R.string.profile_photo), null, 0,
                            intent.getStringExtra(getString(R.string.selected_image)), null, null, null, null, null, null, null);
                    mUploading.setVisibility(View.VISIBLE);
                    mProgressBar.setVisibility(View.VISIBLE);
                }
                    ...
                    mProgressBar.setVisibility(View.VISIBLE);
                    firebaseMethods.uploadNewPhoto(getString(R.string.profile_photo), null, 0,
                            intent.getStringExtra(getString(R.string.selected_bitmap)),null, null, null, null, null, null, null);
                    mUploading.setVisibility(View.VISIBLE);
                    mProgressBar.setVisibility(View.VISIBLE);
                }
