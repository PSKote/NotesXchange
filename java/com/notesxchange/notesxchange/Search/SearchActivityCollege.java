...
import com.notesxchange.notesxchange.Utils.CollegefeedListAdapter;
 ...
 * Search by College
 */
public class SearchActivityCollege extends AppCompatActivity implements
        CollegefeedListAdapter.OnLoadMoreItemsListener{
    ...
    //vars
    private Context mContext = SearchActivityCollege.this;
    private ArrayList<String> collegeList;
    private String college;
    private Spinner mCollege;
    private ArrayList<Photo> mPhotos;
    private ArrayList<Photo> mPaginatedPhotos;
    //private ArrayList<String> mFollowing;
    private ListView mListView;
    private CollegefeedListAdapter mAdapter;
    private int mResults;
    private String collegedb;
    ...
    /*
     * Initialize list of college
     */
    private void initList() {
        collegeList.add("IIIT, Bangalore");
        collegeList.add("Other");;

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SearchActivityCollege.this,
        ...
        mCollege.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                collegedb = college.replace(".","").replace(" ","_");
                mPhotos.clear();
                getPhotos();
            }
    ...
    /*
     * Get photos of selected college
     */
    private void getPhotos(){
        ...
        try {
            Query query = reference
                    ...
                    .child(getString(R.string.dbname_college))
                    .child(collegedb);
...
//                    .equalTo(mFollowing.get(i));
            ...
            Toast.makeText(mContext, "Choose College", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayPhotos(){
        ...
        if(mPhotos != null){
            try{
                ...
                mAdapter = new CollegefeedListAdapter(mContext, R.layout.layout_mainfeed_listitem, mPaginatedPhotos);
    ...
    public void onCommentThreadSelected(Photo photo, String callingActivity){
        ...
        args.putString(getString(R.string.search_activity_college), getString(R.string.search_activity_college));
