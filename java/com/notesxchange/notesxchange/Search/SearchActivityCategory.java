...
import com.notesxchange.notesxchange.Home.HomeFragment;
import com.notesxchange.notesxchange.Login.LoginActivity;
import com.notesxchange.notesxchange.R;
import com.notesxchange.notesxchange.Upload.NextActivity;
import com.notesxchange.notesxchange.Utils.CategoryfeedListAdapter;
 ...
 * Serahcby Category
 */
public class SearchActivityCategory extends AppCompatActivity implements
        CategoryfeedListAdapter.OnLoadMoreItemsListener{
    ...
    private static final String TAG = "SearchActivityCategory";

    //vars
    private Context mContext = SearchActivityCategory.this;
    ...
    private CategoryfeedListAdapter mAdapter;
    ...
    /*
     * Initialize list of category to search
     */
    private void initList() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SearchActivityCategory.this,
        ...
        mCategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                categorydb = category.replace(".","").replace(" ","_");
                mPhotos.clear();
                getPhotos();
            }
    ...
    /*
     * get photos of selected category
     */
    private void getPhotos(){
        ...
        try {
            Query query = reference
                    ...
                    .child(getString(R.string.dbname_category))
                    .child(categorydb);
...
//                    .equalTo(mFollowing.get(i));
            ...
            Toast.makeText(mContext, "Choose Category", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayPhotos(){
        ...
        if(mPhotos != null){
            try{
                ...
                mAdapter = new CategoryfeedListAdapter(mContext, R.layout.layout_mainfeed_listitem, mPaginatedPhotos);
    ...
    public void onCommentThreadSelected(Photo photo, String callingActivity){
        ...
        args.putString(getString(R.string.search_activity_category), getString(R.string.search_activity_category));
